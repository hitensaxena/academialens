...
1.  **"Your Research Snapshot" (Hero/Overview):**
    ...
    * **High-Level Progress:** Display key metrics framed as *research progress* and *AI value generated*, not just raw counts. Examples: "Papers Processed," "Active Investigations," "Insights Generated (AI-driven)."
...
2.  **"Continue Your Work" (Recent Activity & Status):**
    * **Continuity:** Focus on documents and projects that are *in progress* or *recently completed analyses*.
...
4.  **"Latest Discoveries & AI Insights" (New Emphasis):**
    * **Proactive Insights:** This is a crucial new section. Display AI-generated snippets of significant findings, emerging themes, identified knowledge gaps, or critical claims from *recent analyses*.
...
* **Personalized:** The hub reflects *your* research, *your* progress, *your* discoveries.
...
* **Key Progress Metrics (Shadcn UI `Card` components):** Concise, visually appealing summaries of their overall research engagement and AI value.
    * **"Knowledge Base Growth":**
        ...
        * *UX Justification:* Reframe document count as a growing personal library of analyzed content.
    * **"Active Investigations":**
        * **Metric:** `[Number]` (e.g., "3")
        * **Context:** "Ongoing Research Projects"
        * **Trend:** `+1 new this month`
        * *UX Justification:* Highlights current focus areas and encourages project-based work.
    * **"AI Insights Generated":**
        * **Metric:** `[Number]` (e.g., "87")
        * **Context:** "Summaries, Claims, & Discoveries"
        * **Trend:** `+15 this week`
        * *UX Justification:* Directly showcases the value derived from AI processing, reinforcing the core benefit.
    * **"Analysis Credits Remaining":** (Crucial for SaaS freemium model)
        ...
        * *UX Justification:* Transparently communicates usage without feeling punitive. Encourages upgrades by highlighting remaining capacity.
...
* **Content:** A set of prominent, action-oriented buttons, possibly arranged in a grid or flow.
    ...
    * *UX Justification:* Provides clear pathways for all common research starting points, making it easy to begin new tasks.
...
* **Content:** A dynamic, scrollable feed of AI-generated insights from recent analyses, designed to highlight value.
    ...
    * *UX Justification:* This is a powerful differentiator. It proactively shows the user the value AcademiaLens is generating, encouraging deeper engagement and exploration of AI features. It feels like an intelligent assistant, not just a tool.
